...
class TestYapperSHAP:
    ...
    def test_shap_values_returned(self, yapper_no_llm: TheYapper, pipeline):
        txn = {"TransactionAmt": 500.0, "ProductCD": "W"}
    ...
    def test_feature_contributions_structure(self, yapper_no_llm: TheYapper, pipeline):
        txn = {"TransactionAmt": 200.0}
        features = preprocess(pipeline, txn)
        result = yapper_no_llm.explain(
            transaction=txn,
            prediction=0.3,
    ...
    def test_shap_values_are_nonzero(self, yapper_no_llm: TheYapper, pipeline):
        txn = {"TransactionAmt": 500.0, "ProductCD": "W"}
        features = preprocess(pipeline, txn)
        result = yapper_no_llm.explain(
            transaction=txn,
...
class TestYapperTemplateFallback:
    def test_llm_not_used_without_key(self, yapper_no_llm: TheYapper, pipeline):
        txn = {"TransactionAmt": 300.0}
        features = preprocess(pipeline, txn)
        result = yapper_no_llm.explain(
            transaction=txn,
            prediction=0.7,
    ...
    def test_explanation_present_without_llm(self, yapper_no_llm: TheYapper, pipeline):
    ...
    def test_summary_present(self, yapper_no_llm: TheYapper, pipeline):
        txn = {"TransactionAmt": 100.0}
        features = preprocess(pipeline, txn)
        result = yapper_no_llm.explain(
            transaction=txn,
    ...
    def test_recommended_action_present(self, yapper_no_llm: TheYapper, pipeline):
        txn = {"TransactionAmt": 100.0}
        features = preprocess(pipeline, txn)
        result = yapper_no_llm.explain(
            transaction=txn,
    ...
    def test_confidence_factors_list(self, yapper_no_llm: TheYapper, pipeline):
        txn = {"TransactionAmt": 100.0}
        features = preprocess(pipeline, txn)
        result = yapper_no_llm.explain(
            transaction=txn,
    ...
    def test_to_dict_serialisable(self, yapper_no_llm: TheYapper, pipeline):
        txn = {"TransactionAmt": 100.0}
        features = preprocess(pipeline, txn)
        result = yapper_no_llm.explain(
            transaction=txn,
